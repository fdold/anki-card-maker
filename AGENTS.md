...
Do not duplicate or restate project requirements in this file. If a requirement is missing, outdated, ambiguous, or contradicted by code or user input, update or clarify `docs/requirements/REQUIREMENTS.md` first, then implement against it.
...
- If the user gives a new requirement, record it in `docs/requirements/REQUIREMENTS.md` instead of expanding this file.
